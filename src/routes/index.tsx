        ...
        <section className="relative overflow-hidden bg-primary text-primary-foreground">
          ...
          <div className="mx-auto max-w-7xl px-6 py-20 md:py-28 relative">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-[13px] sm:text-base md:text-lg text-primary-foreground/85 leading-relaxed break-keep">
                <span className="block whitespace-nowrap">강의 자료·과제·공지사항을 한 곳에서 공유하는 {DEPARTMENT_NAME} 전용 디스크입니다.</span>
                <span className="block whitespace-nowrap">교수와 학생 모두 강의실, 자료실, 과제, 1:1 문의를 편하게 이용할 수 있습니다.</span>
              </p>
